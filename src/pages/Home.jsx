...
const Home = () => {
  return (
    <>
      <section className="relative w-full mx-auto  rounded-lg h-full md:h-[60vh] xl:h-[110vh] overflow-hidden">
        ...
        <div className="w-11/12 xl:w-8/12 mx-auto pt-32 py-20 md:pt-20 h-full grid grid-cols-1 tece gap-5 xl:gap-10 z-20 relative text-white">
          <div className="h-full flex flex-col justify-center items-center gap-3 text-center">
            ...
            Premium Elevators in Kerala.<br/> Aaron Elevators
            </h1>
            <p className="xl:w-[60%] mx-auto text-sm text-center font-extralight tracking-tighter md:tracking-tight md:w-full">
            Transform your vertical mobility experience with Aaron Elevators, Our Elevators in Kerala combines innovation, safety, and reliability, making us the best elevator company in Kerala.
            </p>
      ...
      <section className="bg-white pb-10 ">
        <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          ...
          <div className="xl:col-span-2 bg-gray-100 rounded-lg flex p-5 xl:p-10 flex-col gap-3 h-full justify-center text-mainclr">
              ...
              About<br/> <span className="text-mainbtn">Aaron Elevators</span>
              </h2>
          ...
          <div className=" grid grid-cols-2 xl:grid-cols-4 gap-2 md:gap-3 mt-5">
                <div className="border bg-white h-full xl:h-60 flex flex-col justify-center p-2 md:p-5 rounded-lg ">
                  <RiDoubleQuotesL className="text-5xl text-mainbtn"/>
                    <h4 className="text-xs md:text-base xl:text-lg font-medium pb-2">Superior Customer Service</h4>
                ...
                <div className="border bg-white rounded-lg  h-full xl:h-60 flex flex-col justify-center p-2 md:p-5 ">
                  <RiDoubleQuotesL className="text-5xl text-mainbtn"/>
                    <h4 className="text-xs md:text-base xl:text-lg font-medium pb-2">Modernization Solutions</h4>
                ...
                <div className="border bg-white rounded-lg  h-full xl:h-60 flex flex-col justify-center p-2 md:p-5">
                  <RiDoubleQuotesL className="text-5xl text-mainbtn"/>
                    <h4 className="text-xs md:text-base xl:text-lg font-medium pb-2">Supply & Installation</h4>
                ...
                <div className="border bg-white h-full xl:h-60 flex flex-col justify-center p-2 md:p-5 rounded-lg ">
                  <RiDoubleQuotesL className="text-5xl text-mainbtn"/>
                    <h4 className="text-xs md:text-base xl:text-lg font-medium pb-2">24/7 Services</h4>
      ...
      <section className="bg-white pb-20 pt-10  text-mainclr">
        <div className="w-fullo text-center">
            ...
            <p className="text-xs md:text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate, voluptas.</p>
      ...
      <section className="mt-20">
        <div className="relative p-5 py-20 h-full flex justify-center items-center rounded-lg overflow-hidden">
          <img className="absolute object-cover top-0 left-0 w-full h-full" src={Ban1} alt="" />
          ...
          <div className="z-20 relative text-white text-center flex flex-col gap-2">
            <h4 className="font-normal text-4xl xl:text-6xl">Get a Free Consultation</h4>
            <p className="text-xs md:text-sm ">Take the first step towards superior vertical mobility. Contact Kerala's trusted elevation experts for a consultation.</p>
            <ContactForm/>
